    ...
    <div class="card-body">
        <div class="mb-3">
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addStudentModal">
                <i class="fas fa-plus me-2"></i>Admit New Student
            </button>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="fas fa-user-plus me-2"></i>Admit New Student
                </h5>
            ...
            <form id="addStudentForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <hr class="my-3">
                    <h6 class="mb-3"><i class="fas fa-graduation-cap me-2"></i>Course Enrollment (Optional)</h6>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Select Course</label>
                            <select class="form-select" name="course_id" id="course_select">
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', function () {
        ...
        // Filter Batches based on Course Selection
        ...
        console.log('Institute students page script loaded, jQuery available');
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        Swal.fire({
                            icon: 'success',
                            title: 'Success!',
                            text: response.message || 'Student admitted successfully',
                            timer: 2000
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: response.message || 'Failed to admit student'
                        });
                    }
                },
                error: function (xhr) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success && response.data) {
                        ...
                        const html = `
                        <div class="row">
                            <div class="col-md-6 mb-3"><strong>Student ID:</strong> ${s.student_id || 'N/A'}</div>
                            <div class="col-md-6 mb-3"><strong>Name:</strong> ${s.first_name} ${s.last_name}</div>
                            <div class="col-md-6 mb-3"><strong>Email:</strong> ${s.email || 'N/A'}</div>
                            <div class="col-md-6 mb-3"><strong>Phone:</strong> ${s.phone}</div>
                            <div class="col-md-6 mb-3"><strong>Gender:</strong> ${s.gender ? s.gender.charAt(0).toUpperCase() + s.gender.slice(1) : 'N/A'}</div>
                            <div class="col-md-6 mb-3"><strong>Date of Birth:</strong> ${s.dob || 'N/A'}</div>
                            <div class="col-12 mb-3"><strong>Address:</strong><br>${s.address || 'N/A'}</div>
                            <div class="col-md-6 mb-3"><strong>Guardian Name:</strong> ${s.guardian_name || 'N/A'}</div>
                            <div class="col-md-6 mb-3"><strong>Guardian Phone:</strong> ${s.guardian_phone || 'N/A'}</div>
                            <div class="col-md-6 mb-3"><strong>Enrollment Date:</strong> ${s.enrollment_date || 'N/A'}</div>
                            <div class="col-md-6 mb-3"><strong>Status:</strong> <span class="badge badge-${s.status === 'active' ? 'success' : 'danger'}">${s.status ? s.status.charAt(0).toUpperCase() + s.status.slice(1) : 'N/A'}</span></div>
                        </div>
                    `;
